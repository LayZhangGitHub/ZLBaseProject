...
- (void)loadData {
    ...
    NSString *TMOrderListLink       = [LocalAppHost(MallOrderList) addURLParamsFromDictionary:@{@"type":@"1"}];
    NSString *TMBecomeMemberLink    = LocalAppHost(BecomeMemberHost);
    NSString *TMMallCartLink        = LocalAppHost(MallCart);
    NSString *TMMyCollectionLink    = LocalAppHost(MyCollection);
    NSString *TMPointDetailLink     = LocalAppHost(PointDetail);
    
    // 以后整理
    self.menu = [NSMutableArray arrayWithArray:@[
                  @{@"type":@"empty",},
                  @{@"type":@"item", @"icon":@"icon_mine_cart", @"title":@"购物车", @"link":TMMallCartLink, @"line":@YES, @"arrow":@YES,@"value":@""},
                  @{@"type":@"item", @"icon":@"icon_mine_collection", @"title":@"我的收藏", @"link":TMMyCollectionLink, @"line":@YES, @"arrow":@YES,@"value":@""},
                  @{@"type":@"item", @"icon":@"icon_mine_point", @"title":@"淘米余额", @"link":TMPointDetailLink, @"line":@YES, @"arrow":@YES,@"value":@""},
    ...
    [MineRequest getMineDataWithParams:nil success:^(TMMineInfoModel *resultModel) {
        ...
        if (resultModel) {
            ...
            [NSMutableArray arrayWithArray:@[ @{@"type":@"empty",},
                                              ...
                                              @{@"type":@"item", @"icon":@"icon_mine_collection", @"title":@"我的收藏", @"link":TMMyCollectionLink, @"line":@YES, @"arrow":@YES,@"value":@""},
                                              @{@"type":@"empty",},
                                              @{@"type":@"item", @"icon":@"icon_mine_point", @"title":@"淘米余额", @"link":TMPointDetailLink, @"line":@YES, @"arrow":@YES,@"value":resultModel.points},
                                              @{@"type":@"item", @"icon":@"icon_mine_pointorder", @"title":@"淘米商城订单", @"link":TMOrderListLink, @"line":@YES, @"arrow":@YES,@"value":@""},
                                              @{@"type":@"empty",},
                                              @{@"type":@"item", @"icon":@"icon_mine_ member", @"title":@"成为会员", @"link":TMBecomeMemberLink, @"line":@YES, @"arrow":@YES,@"value":@""},
