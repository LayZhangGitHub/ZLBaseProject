  ...
  otherButtonTitles:(NSArray *)otherButtonTitles {
    ...
    if (self) {
        ...
        if (title) {
            ...
            self.titleLabel.textColor = ZLThemeCtrInstance.titleColor;
        ...
        if (message) {
            ...
            self.messageLabel.font = ZLNormalFont(36 * SCALE);
            
            CGSize size = [message sizeWithUIFont:ZLNormalFont(36 * SCALE) forWidth:self.messageLabel.width];
        ...
        if (numberOfButton > 0) {
            ...
            if (numberOfButton == 2) {
                ...
                if ([confirmButtonTitle isNotEmptyString]) {
                    ...
                    [confirmButton setTitleColor:ZLThemeCtrInstance.titleColor forState:UIControlStateNormal];
